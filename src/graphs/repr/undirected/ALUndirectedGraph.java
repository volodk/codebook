...
public class ALUndirectedGraph implements Undirected {
    
    protected int V, E;
    private List< Set<Edge> > adjList;

    public ALUndirectedGraph(int V) {
        this.V = V;
    ...
    public ALUndirectedGraph(int v, int e, List<Set<Edge>> adjList) {
        V = v;
        E = e;
    ...
    public Graph reverse() {
        ...
        return new ALUndirectedGraph(V, E, reversedAdjList);
    }
